...
export const FEDERAL_BRACKETS: Record<string, TaxBracket[]> = {
  single: [
...
// Long-term capital gains brackets (for reference, not used yet since all trades are short-term day trades)
